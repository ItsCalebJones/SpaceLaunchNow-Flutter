...
class _EventListPageState extends State<EventListPage> {
    ...
    return new Padding(
      ...
      child: Card(
        ...
        children: <Widget>[
          ...
          new Text(event.name, style: Theme.of(context).textTheme.title),
          new Text(event.location, style: Theme.of(context).textTheme.subtitle),
  ...
  void _navigateToLaunchDetails(
      {Event event, Object avatarTag, String launchId}) {
    Ads.hideBannerAd();
